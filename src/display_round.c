...
void update_arc(int speed) {
  target_angle = (speed*angle_increment)/100;
...
void update_angles(int max_speed) {
  // All speeds are in KPH
	...
	angle_increment = 36000/max_speed;
	...
	light_green_angle = (light_green_speed*angle_increment)/100;
	yellow_angle = (yellow_speed*angle_increment)/100;
	orange_angle = (orange_speed*angle_increment)/100;
	red_angle = (red_speed*angle_increment)/100;
}
